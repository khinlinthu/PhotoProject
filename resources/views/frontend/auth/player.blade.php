    				...
    				<div class="col-lg-6 col-md-6 col-sm-12 reg">
                        <div class="registration-area">
                            ...
                            <div class="login-header">
                                    <h3><span class="text-muted">PhotoContest | </span>Player Register <br><a
                                            href="{{ route('user.create') }}">Not a player?</a>
                                    </h3>
                                </div>
                            <form action="{{ route('user.playerstore') }}" method="POST" enctype="multipart/form-data">
                                 @csrf
                                <fieldset>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button class="btn-send" type="submit">player</button>
