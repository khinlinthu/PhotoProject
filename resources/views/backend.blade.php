...
<html lang="en">
  <head>
    ...
    <title>Photo Contest Backend</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li >
            <a href="{{ route('user.index') }}" class="app-menu__item {{ Request::is('user*') ? 'active' : '' }}"><i class="app-menu__icon fa fa-user"></i> <span class="app-menu__label"> Users </span></a>
        </li>
